...
#+LaTeX_HEADER:
#+LaTeX_HEADER:\textsc{\huge \bfseries \thetitle}\\[0.5cm]
#+LaTeX_HEADER:
#+LaTeX_HEADER:\includegraphics[width=0.9\textwidth]{./patria-o-netflix.png}~\\[1cm]
#+LaTeX_HEADER:
#+LaTeX_HEADER:\emph{Author:}\\
#+LaTeX_HEADER:\theauthor
#+LaTeX_HEADER:
#+LaTeX_HEADER:\vfill
#+LaTeX_HEADER:
